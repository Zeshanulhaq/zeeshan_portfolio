      ...
      >
        <div className="app__header-badge ">
          ...
          <Link
            ...
            className="min-w-[290px] transition duration-300 box-shadow-white shadow-lg lg:mt-24 mt-12 flex flex-row justify-start items-center my-4 p-4 rounded-[10px] cursor-pointer bg-secondary-color dark:bg-light-dark-bg"
          >
            <img
              src="/email.png"
              alt="email"
